...
function App() {
  return (
      <div style={{width: '100%', height: '100%', position: 'relative', background: 'white'}}>
        ...
        <img style={{width: 1424, height: 573, left: 0, top: 75, position: 'absolute', boxShadow: '8px 8px 8px ', filter: 'blur(8px)'}} src="https://images.pexels.com/photos/235725/pexels-photo-235725.jpegn"  alt={"lol"}/>
        ...
        <img style={{width: 658, height: 370, left: 0, top: 648, position: 'absolute'}} src="https://via.placeholder.com/658x370"  alt={"lol"}/>
        <div style={{width: 1424, height: 445, left: 0, top: 1018, position: 'absolute', boxShadow: '0px 4px 11px black inset'}}>
          <div style={{width: 5696, height: 446, left: 0, top: -1, position: 'absolute'}}>
            <img style={{width: 1424, height: 445, left: 1424, top: 0, position: 'absolute'}} src="https://via.placeholder.com/1424x445"  alt={"alt"}/>
            <img style={{width: 1424, height: 445, left: 0, top: 1, position: 'absolute'}} src="https://via.placeholder.com/1424x445"  alt={"alt"}/>
            <img style={{width: 1424, height: 445, left: 2848, top: 1, position: 'absolute'}} src="https://via.placeholder.com/1424x445"  alt={"alt"}/>
            <img style={{width: 1424, height: 445, left: 4272, top: 1, position: 'absolute'}} src="https://via.placeholder.com/1424x445"  alt={"alt"}/>
          </div>
        </div>
        ...
        <img style={{width: 103, height: 103, left: 0, top: 1463, position: 'absolute'}} src="https://via.placeholder.com/103x103"  alt={"alt"}/>
        <img style={{width: 76, height: 76, left: 0, top: 0, position: 'absolute'}} src="https://via.placeholder.com/76x76"  alt={"alt"}/>
      </div>
  );
}
