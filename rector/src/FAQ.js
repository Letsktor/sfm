...
import masodik from "./szovjetmaci.png";
import harmadik from "./Rectangle_41.png";
...
function FAQ() {
    return (
        <div style={{width: '100%', height: '100%', position: 'relative', background: 'white'}}>
            ...
            <div style={{width: 114, height: 29, left: 1252, top: 22, position: 'absolute', textAlign: 'center', color: '#8F0000', fontSize: 32, fontFamily: 'Raleway', fontWeight: '700', wordWrap: 'break-word'}}>FAQ</div>
            <div style={{width: 1424, height: 105, left: 0, top: 1463, position: 'absolute', background: '#E1AD01'}}></div>
            <img style={{width: 103, height: 103, left: 0, top: 1463, position: 'absolute'}} src={masodik} />
            ...
            <img style={{width: 1424, height: 376, left: 0, top: 73, position: 'absolute', background: 'linear-gradient(0deg, #D9D9D9 0%, #D9D9D9 100%)'}} src={harmadik} />
